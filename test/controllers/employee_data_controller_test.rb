...
class EmployeeDataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_datum" do
    assert_difference('EmployeeDatum.count') do
      post employee_data_url, params: { employee_datum: { name: @employee_datum.name, pass: @employee_datum.pass, role: @employee_datum.role, user: @employee_datum.user } }
    end
  ...
  test "should update employee_datum" do
    patch employee_datum_url(@employee_datum), params: { employee_datum: { name: @employee_datum.name, pass: @employee_datum.pass, role: @employee_datum.role, user: @employee_datum.user } }
